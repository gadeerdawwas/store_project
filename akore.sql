...
--
-- Host: localhost
-- Generation Time: Apr 30, 2022 at 08:45 PM
...
(5, '2022_04_27_070452_create_companies_table', 1),
(6, '2022_04_27_070535_create_banks_table', 1),
(7, '2022_04_27_070710_create_famouses_table', 1);
...
(1, 'admin', 'admin@gmail.com', '$2y$10$rgvWv3MKxYlI7rlF5RlwpOuAhD9eBbxNhvUMWNbzg4ZMawq07ykee', 'admin', '1', NULL, NULL, NULL, NULL),
(4, 'taher', 'taher@akotime.com', '$2y$10$ZzA36JfJ0rl3NtEsLchU0uXK6Ts9rmXvv/rb1UBiXmzk.qE5Toj1K', 'admin', '1', NULL, NULL, NULL, NULL);
...
ALTER TABLE `famouses`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `famouses_email_unique` (`email`);
